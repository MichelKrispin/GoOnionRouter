...
const animateRouter = (route) => {
  ...
  const createBox = (title, x, y, borderColor, stretch = 1) => {
  ...
  const base = () => {
    ...
    // Create the nodes
    createBox(`${route[0]} #1`, nodeX, node1Y, '#BC751C', 1.5);
    createBox(`${route[1]} #1`, nodeX, node2Y, '#BC751C', 1.5);
    createBox(`${route[2]} #1`, nodeX, node3Y, '#BC751C', 1.5);
